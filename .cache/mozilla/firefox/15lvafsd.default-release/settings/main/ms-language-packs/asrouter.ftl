...
## External string for cfr-whatsnew-protections-header
cfr-whatsnew-protections-header = Protections at a glance

## External string for cfr-whatsnew-protections-body
...
## External string for cfr-whatsnew-protections-cta-link
cfr-whatsnew-protections-cta-link = View Protections Dashboard

## External string for cfr-whatsnew-protections-icon-alt
cfr-whatsnew-protections-icon-alt = Shield icon

## External string for cfr-whatsnew-better-pdf-header
cfr-whatsnew-better-pdf-header = Better PDF experience

## External string for cfr-whatsnew-better-pdf-body
